 ...
 *
 */
public class JGraphInitialStateView extends VertexView {
	...
	/**
	 */
	public static transient JGraphInitialVertexRenderer renderer = new JGraphInitialVertexRenderer();

	/**
	 */
	public JGraphInitialStateView() {
		super();
	}

	/**
	 */
	public JGraphInitialStateView(Object cell) {
		super(cell);
	}
	...
	/**
	 */
	public static class JGraphInitialVertexRenderer extends VertexRenderer {
		...
		public void paint(Graphics g) {
			...
			if (bordercolor != null) {
				...
				g.drawLine(0, 10, 11, 11);
				g.drawLine(10, 0, 11, 11);
			}
			if (selected) {
				g2.setStroke(new BasicStroke(b));
