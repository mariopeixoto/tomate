 ...
 *
 */
public class JGraphNormalStateView extends VertexView {
	...
	/**
	 */
	public static transient JGraphNormalVertexRenderer renderer = new JGraphNormalVertexRenderer();

	/**
	 */
	public JGraphNormalStateView() {
		super();
	}

	/**
	 */
	public JGraphNormalStateView(Object cell) {
		super(cell);
	}
	...
	/**
	 */
	public static class JGraphNormalVertexRenderer extends VertexRenderer {
